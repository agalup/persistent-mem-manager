...
def draw_graph(plt, testcase, alloc_per_thread, iteration_num, SMs, allocs_size, 
               ...
               app_sync_pmm, uni_req_num_pmm, app_sync, uni_req_num, use_malloc):
...
def run_test(testcase, alloc_per_thread, device, pmm_init, perf_alloc, use_malloc, instant_size, iteration_num):
    ...
    #draw both
    draw_graph(plt, testcase, alloc_per_thread, iteration_num, SMs, allocs_size, 
               sm_app, sm_mm, app_launch, app_finish, 
               app_sync_pmm, uni_req_num_pmm, app_sync, uni_req_num, use_malloc)
...
def main(argv):
    ...
    #run_test("OUROBOROS", int(alloc_per_thread), device, pmm_init, perf_alloc, malloc_on, instant_size, int(iteration_num))
